...
var siteDir = './',
    ...
    csopDir = asseDir + 'css/',
    jsopDir = asseDir + 'js/',
    sassDir = asseDir + 'scss/',
    // ignoreFile = [sassDir + 'share-link.scss',sassDir + 'share-link.scss',sassDir + 'company-outlines.scss',sassDir + 'homepage-newslist-table.scss',sassDir + 'homepage-newslist-table.scss'],
    ignoreFile = [sassDir + 'CSS3MediaQueriestemplate.scss'],
    sassfile = [],
    ignoreFilePlug = '';
...
function watchFiles() {
    ...
    gulp.watch(sassDir + "js/**/*", gulp.series(scripts));
    // gulp.watch(
    //   [
    //     "./_includes/**/*",
    //     "./_layouts/**/*",
...
const build = gulp.series(gulp.parallel(css, js,clean));
