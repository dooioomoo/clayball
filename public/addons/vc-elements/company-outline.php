...
// Element Class
    class Clayball_Company_outline extends WPBakeryShortCode
    {
        ...
        public function Clayball_Company_outline_map()
        {
            ...
            vc_map(
                array(
                    'name' => __('信息列表', 'Clayball-lang'),//VC元件名称
                    'base' => 'Clayball_Company_outline', //对应shortcode
                    'description' => __('信息列表排列', 'Clayball-lang'), //远见说明
                    ...
                    'params' => array(
                        ...
                        array(
                            ...
                            'std' => '', // 默认选项
                            'description' => __('Choice a content type', 'Clayball-lang'),
                            'group' => __('base', 'Clayball-lang'),
                        ),
                        // params group
                        array(
                            'type' => 'param_group',
        ...
        public function Clayball_Company_outline_html($atts)
        {
            ...
            <div class="<?php echo esc_attr($classname); ?>">
                <div class="Clayball-company_outlines_list <?php echo esc_attr($changestyle); ?>">
                    <?php
                    foreach ($comp_outlines as $comp_columns) {
                        echo '<dl class="line-row">';
