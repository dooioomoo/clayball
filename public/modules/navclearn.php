...
//add_filter('wp_nav_menu_args', 'clayball_nav_menu_args');
//add_filter('nav_menu_item_id', '__return_null');

function clayball_nav_menu_args($args = '') {
    $nav_menu_args = [];
    ...
    if (!$args['walker']) {
        $nav_menu_args['walker'] = new clayball_walknav();
    }
...
class clayball_walknav extends \Walker_Nav_Menu
{
